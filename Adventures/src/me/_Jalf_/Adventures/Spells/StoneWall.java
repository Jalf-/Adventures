...
public class StoneWall 
{
	...
	public StoneWall(Main plugin)
	{
		StoneWall.plugin = plugin;
	}
	@SuppressWarnings("deprecation")
	public static void stoneWallSpell(Player player, int range, int length, int height, final int time)
	{		
		...
		if (targetBlock != null)
		{
			if (targetBlock.getType() != Material.AIR)
			{
				...
				for (Block newWallLocations : wallLocations)
				{
					...
					if (breakWhile == false)
					{
						newWallLocations.setType(Material.SMOOTH_BRICK);						 
